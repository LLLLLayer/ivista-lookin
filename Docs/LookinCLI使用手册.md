...
lookin apps --transport simulator
lookin apps --bundle-id com.example.demo
lookin apps --device-id 12
lookin apps --port 47175
```
...
lookin tree --bundle-id com.example.demo --depth 2
...
lookin find --bundle-id com.example.demo UILabel --limit 20
...
```bash
lookin tree --bundle-id com.example.demo --oid 130 --depth 3
```
...
```bash
lookin find --bundle-id com.example.demo UIButton --limit 5
lookin inspect --bundle-id com.example.demo --oid 130
lookin attrs --bundle-id com.example.demo --oid 130 --json
```
...
lookin screenshot --bundle-id com.example.demo --oid 130 --type solo --out button-solo.png
```
...
lookin export --bundle-id com.example.demo --compression 0.6 --out demo.lookin
```
...
lookin selectors --bundle-id com.example.demo --class UIButton --filter title
```
...
```bash
lookin apps --json | jq .
lookin find --bundle-id com.example.demo UIButton --json | jq '.matches[].oid'
lookin attrs --bundle-id com.example.demo --oid 130 --json > attrs.json
```
...
lookin tree --bundle-id com.example.demo --device-id 12
lookin tree --bundle-id com.example.demo --port 47175
```
